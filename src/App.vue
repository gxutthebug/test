<template>
  <div>
              <!-- 自定义属性就不用变量传入了 -->
    <MyHeader title="拼夕夕"  background="red"></MyHeader>

    <div class="main"> <MyGoods v-for="obj in list" :key="obj.id"  :gObj="obj" ></MyGoods></div>
...
import MyHeader from './components/tou.vue'
